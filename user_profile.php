<?php 
	...
	include 'connect.php';
		...
		if (!isset($_SESSION["email"])) {
			echo "<script> window.location.replace('http://localhost/healthyburst_site/index.php');</script>";
			exit();	
		}

		if(isset($_SESSION['admin'])){
   echo "<script> window.location.replace('http://localhost/healthyburst_site/admin_area/admin_index.php');</script>";
    exit();
}	
	...
	$_SESSION['acc_no'] = $row_prod['acc_no'];
	$fname = $row_prod['fname'];
	$lname = $row_prod['lname'];
	$email = $row_prod['email'];
	$_SESSION['address'] = $row_prod['address'];
	$birthday = $row_prod['birthday'];
	$_SESSION['pnumber'] = $row_prod['phonenumber'];
		...
		<table>
				...
				<tbody>
					...
					<tr>
						...
						<td style='text-align:left;'>".$_SESSION['pnumber']."</td>
					</tr>
					<tr>
						<td><span>Address :</span></td>
						<td style='text-align:left;'>".$_SESSION['address']."</td>
					</tr>
					...
					<tr>
						...
						<td style='text-align:left;'>".$_SESSION['acc_no']."</td>
					</tr>
			...
			<br>
				...
				<a href='update_info.php' style='height: 35px; width: 150; margin-right: auto; margin-left: auto; text-align: center; background: #131313; color: #E1E1E1; border-radius: 3px; cursor: pointer; text-decoration: none; line-height: 2.3; padding: 10px;'> Update Profile</a> <br><br>

				<a href='changepass.php' style='height: 35px; width: 150; margin-right: auto; margin-left: auto; text-align: center; background: #131313; color: #E1E1E1; border-radius: 3px; cursor: pointer; text-decoration: none; line-height: 2.3; padding: 10px;'> Change Password</a> <br><br>

				<a href='user_orders.php' style='height: 35px; width: 150; margin-right: auto; margin-left: auto; text-align: center; background: #131313; color: #E1E1E1; border-radius: 3px; cursor: pointer; text-decoration: none; line-height: 2.3; padding: 10px;'>Purchase History</a>   
