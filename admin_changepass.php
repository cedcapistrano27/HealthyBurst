...
<div class="user_info">
   ...
   if (isset($_POST['change']))
  {
      ...
      if ($row = mysqli_fetch_array( $result ))
      {
          if ($newpass == $conpass)
        		{
        			mysqli_query($db, "INSERT INTO event_log( event_user, event_activty, event_timestamp) VALUES ('".$_SESSION["admin"]." ".$_SESSION["emailadmin"]."','Changed Password',current_timestamp())");
    				...
    				echo "<script> window.location.replace('http://localhost/healthyburst_site/admin_profile.php');</script>";
    			}
    			else
    			{
		...
		<table>
				...
				<tbody>
					<tr>
						...
						<td style='text-align:left;'><input type="text" name="acc_no" value="<?php echo $admin["acc_no"];?>" readonly=""></td>
					</tr>
			...
			<a href="admin_profile.php" style='height: 35px; width: 150; margin-right: auto; margin-left: auto; text-align: center; background: #131313; color: #E1E1E1; border-radius: 3px; cursor: pointer; text-decoration: none; line-height: 2.3; padding: 10px;'> Go Back To Your Profile</a> <br><br> 
