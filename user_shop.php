<?php 
	...
	Global $db;
	$get_prod = "SELECT * FROM product ORDER BY prod_name LIMIT 0,100";
	...
	$prod_quantity = $row_prod['prod_quantity'];
	...
	if ($prod_quantity > 0) {
		...
		<span><a href='user_shop_details.php?pro_id=$prod_id' style=' background: black; padding: 15px; color:white; text-decoration: none; border-radius: 5px;'>Click Here To See</a><span> <br>
		<br>	
					</div>";
