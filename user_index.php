	...
	<main>
		...
		<section class="sec1">
			...
			<div class="introduction">
				...
				<span style="font-size: 20px;"><b>Welcome !</b>  <?php echo $_SESSION['firstname'] ?></span>
			...
			<br><br>
				...
				<a href="user_shop.php" style="height: 35px; width: 150; margin-right: auto; margin-left: auto; text-align: center; background: #131313; color: #E1E1E1; border-radius: 3px; cursor: pointer; text-decoration: none; line-height: 2.3; padding: 10px;"> Go To Shop</a>  
